...
遇到 **Twilio 21216** 时，按 [官方错误说明](https://www.twilio.com/docs/api/errors/21216)核对风险、监管及适用的 +1 Primary Profile 限制。本轮已只读确认账户 Full/active、余额为正、美国普通号码地理权限开启、已有获批 Individual Primary、缺 Business Primary，账户创建日期在 2025-10-08 及之后；开户地区仍待用户确认，不能仅凭缺 Business Profile 认定根因或自行填写企业资料。处理供应商拒绝后再拨用户授权目标，不重复创建密钥。
